...
[_BL] = LAYOUT_66_ansi(
  ...
  /* Keymap _WORKMAN: Alternate Base Layer
   */
/* [_WORKMAN] = LAYOUT_66_ansi(
 *  KC_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BEPC,            KC_PGUP,
 ...
 *  KC_CCCV, KC_LGUI, KC_LALT,                            LT(_FL,KC_SPC),            KC_RALT, KC_RCTL, MO(_FL),          KC_LEFT, KC_DOWN, KC_RIGHT),
 */
...
[_FL] = LAYOUT_66_ansi(
  ...
  _______, _______, MO(_CL), _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_PGUP, _______, _______,  _______,                   KC_PGUP,

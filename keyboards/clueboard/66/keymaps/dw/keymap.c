...
[QWERTY] = LAYOUT_66_ansi(
  ...
  KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                    MO(LOWER), KC_RCTL, TG(WORKMAN),       KC_LEFT, KC_DOWN, KC_RGHT
),
...
[WORKMAN] = LAYOUT_66_ansi(
  ...
  KC_LCTL, KC_Z,    KC_X,    KC_M,    KC_C,    KC_V,    KC_K,    KC_L,    KC_COMM, KC_DOT,   KC_SLSH, KC_RCTL,                    KC_UP,
  KC_CCCV, KC_LGUI, KC_LALT,                            LT(NAV,KC_SPC),            MO_LOWER, KC_LEAD, _______,           KC_LEFT, KC_DOWN, KC_RIGHT
),
...
[ADJUST] = LAYOUT_66_ansi(
  ...
  RESET,   _______, _______,                              _______,                   _______, MO(_FL), _______,           KC_LEFT, KC_DOWN, KC_RIGHT
),
};

layer_state_t layer_state_set_user(layer_state_t state) {
    return update_tri_layer_state(state, LOWER, NAV, ADJUST);
}

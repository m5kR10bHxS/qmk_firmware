...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY] = LAYOUT_infinity( \
      ...
      KC_LCTL, KC_LGUI, KC_LALT,                  KC_SPC,                                     KC_RALT, KC_RGUI, MO(LOWER), KC_RCTL         \
  ),
 ...
 * |--------+------+------+------+------+------+------+------+------+------+------+-------+-------+-------+-------|
 * |  CCCV  | MENU |  ALT |                       SPACE FN                        |  ALT  |  MENU | LOWER | LEADER|
 *  --------+------+------+-------------------------------------------------------+-------+-------+-------+-------'
 *
 */
  ...
  [WORKMAN] = LAYOUT_infinity( \
      ...
      KC_CCCV, KC_LGUI, KC_LALT,                   LT(NAV,KC_SPC),                             KC_RALT, KC_RGUI, MO(LOWER), KC_LEAD         \
  ),

  [LOWER] = LAYOUT_infinity( \
      ...
      KC_ASOFF, KC_ASDN, _______, _______, KC_VOLD, _______, _______, _______, _______, _______, _______, _______, _______,                    \
